    ...
    return (
        <section id="home" className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem] ">
            ...
            >
                ...
                <span className='font-bold'>+ 4 años</span> de experiencia y disfruto crear <span className='italic'>sitios y apss </span>  {" "}
                <span className='underline'>ReactJS - Angular</span>  {" "}
            </motion.h1>
