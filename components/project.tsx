    ...
    >
      ...
      >
        ...
        <Image
          ...
          quality={95}
          className="absolute hidden sm:block top-8 -right-40 w-[28.25rem] group-even:right-[initial] 
                group-even:-left-40 rounded-t-lg shadow-2xl group-hover:-translate-x-3
                group-hover:translate-y-3 group-hover:-rotate-2 group-hover:scale-[1.04]
                group-even:hover:-translate-x-3 group-even:hover:translate-y-3 group-even:hover:-rotate-2 transition"
        />
      </section>
    </motion.div>
  );
